...
message_menu_t* totrGenerateMenu(int, int, char*, char*, char*);
void totrMenuFree(message_menu_t*);

int totrNewConversation(int, char*, char*, void*, void*);
int totrSMPVerification(int, char*, char*, void*, void*);
int totrEndConversation(int, char*, char*, void*, void*);
int totrVerifyFingerprint(int, char*, char*, void*, void*);
int totrViewSessionID(int, char*, char*, void*, void*);
int totrViewPreferences(int, char*, char*, void*, void*);
bool fileExists(const char *);
void subtractDays(time_t*, const int);
void formatHistoryFileString(std::string*, const char*, const char*, const char*);
int totrViewHistory(int, char*, char*, void*, void*);
int totrOptionsMenu(int, char*, char*, void*, void*);
