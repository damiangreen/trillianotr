...
enum TotrStateSetting
{
	TOTR_STATE_BROADCAST_ID,
	TOTR_STATE_NEW_WINDOW_EVENT_ID,
	TOTR_STATE_DEAD_WINDOW_EVENT_ID,
	TOTR_STATE_CONNECT_EVENT_ID,
	TOTR_STATE_MAX_ID
};
...
{
	private:
		int id_list[TOTR_STATE_MAX_ID];

	public:
		TotrState();

		int GetState(TotrStateSetting);
		int SetState(TotrStateSetting, const int);
