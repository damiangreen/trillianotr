...
#ifndef DLGNEWFINGERPRINT_H
#define DLGNEWFINGERPRINT_H

class CNewFingerDlg : public CDialogImpl<CNewFingerDlg>
{
	private:
		HWND hWnd;
		CStatic hTitle;
	...
	public:
		...
		CNewFingerDlg() : IDD(IDD_NEWFINGERPRINT)
		{
		}
		...
		void MarkComplete(char*, char*);
		void GenerateFingerprint(const char*, const char*);
};
