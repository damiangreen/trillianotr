...
class CSessionDlg : public CDialogImpl<CSessionDlg>
{
	private:
		HWND hWnd;
		CStatic hTitle;
	...
	public:
		...
		CSessionDlg() : IDD(IDD_SESSIONID)
		{
		}

		const int GetResource() { return IDD; }
		...
		LRESULT	OnFinishDlg(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
