...
#ifndef DLGVERIFYFINGERPRINT_H
#define DLGVERIFYFINGERPRINT_H

class CVerifyFingerDlg : public CDialogImpl<CVerifyFingerDlg>
{
	private:
		HWND hWnd;
		CStatic hTitle;
	...
	public:
		...
		CVerifyFingerDlg() : IDD(IDD_VERIFY_FINGERPRINT), fp(NULL)
		{
		}
		...
		BEGIN_MSG_MAP(CVerifyFingerDlg);
		...
		void PopulateMessages(const char*, const char*, Fingerprint*);
};
