...
char* accountNameLookup(char*, int);
int accountConnectionLookup(char*, char*);
char* userDisplayNameLookup(char*, char*, int);

void totrShowVerifyDialog(HWND, ConnContext*, Fingerprint*);
int totrTrustedFingerprint(Fingerprint*);
void totrInitiateSession(ConnContext*);
void totrTerminateSession(ConnContext*);
void totrPopulateKnownConnections();

int accountLookupCallback(int, char*, char*, void*, void*);
int messageWindowEchostate(message_t*, int);
int messageWindowEchostate(int, int, char*, char*, int);
int messageSecureState(int, int, char*, char*, int);
int userStatusLookupCallback(int, char*, char*, void*, void*);
int userDisplayNameCallback(int, char*, char*, void*, void*);
int totrTrustedFingerprint(Fingerprint*);
void totrShowVerifyDialog(HWND, ConnContext*, Fingerprint*);
int collectConnectionsCallback(int, char*, char*, void*, void*);
connection_entry_wrapper_t* collectActiveConnections();
void collectConnectionsFree(connection_entry_wrapper_t*);

void totrPluginAbortSMP(ConnContext*);
