...
#ifndef SMPCHALLENGEDLG_H
#define SMPCHALLENGEDLG_H

// CSMPStartDlg dialog

class CSMPChallengeDlg : public CDialogImpl<CSMPChallengeDlg>
{
	private:
		HWND hWnd;
		const char* question;
	...
	public:
		...
		CSMPChallengeDlg(const char* q) : IDD(IDD_SMPCHALLENGEDLG), question(q)
		{
		}
		...
		BEGIN_MSG_MAP(CSMPChallengeDlg);
